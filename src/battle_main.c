...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8 },
    ...
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 25, BALL_PREMIER },
    ...
    [TRAINER_CLASS_RIVAL_RICHARD] =        { _("{PKMN} TRAINER"), 10, BALL_DUSK },
    [TRAINER_CLASS_MEDIUM] =               { _("MEDIUM"), 5} 
};
