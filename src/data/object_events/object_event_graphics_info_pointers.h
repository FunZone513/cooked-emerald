...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_RivalRichard;
...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_OBJ_EVENT_GFX] = {
    ...
    [OBJ_EVENT_GFX_RIVAL_RICHARD] =            &gObjectEventGraphicsInfo_RivalRichard,
    ...
    //* OW Sprites from FRLG, altered to use Emerald's Palette by Cykada
    ...
    //* Misc Sprites from FRLG, altered to use Emerald's Palette by Cykada
