...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_GALE_WINGS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_SOLAR_POWER, ABILITY_NONE },
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_FRISK, ABILITY_HARVEST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MOON_STONE, SPECIES_TREVENANT})
    },
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_HARVEST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
