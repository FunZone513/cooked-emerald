...
#define WE_FLAG_NO_ENCOUNTER        FLAG_DISABLE_WILD_ENCOUNTERS       // If this flag is set, wild encounters will be disabled.

// Double Wild Battles 
//* The chance is handled with the VAR_WILD_BATTLE_CHANCE variable, custom
...
#define WE_WILD_NATURAL_ENEMIES          FALSE       // If set to TRUE, certain wild mon species will attack other species when partnered in double wild battles (eg. Zangoose vs Seviper)

// Wild Battle Flags
#define WE_FLAG_FORCE_DOUBLE_WILD    FLAG_FORCE_WILD_DOUBLE_BATTLE     // If this flag is set, all land and surfing wild battles will be double battles.
#define WE_SMART_WILD_AI_FLAG        FLAG_ACTIVE_BOSS_BATTLE     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          FLAG_ACTIVE_BOSS_BATTLE     // If this flag is set, the ability to catch wild Pokémon is disabled.
