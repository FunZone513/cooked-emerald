...
#define AI_FLAG_LEADER                (AI_FLAG_SMART_TRAINER | AI_FLAG_KNOW_OPPONENT_PARTY | AI_FLAG_PREDICTION | AI_FLAG_ACE_POKEMON)
#define AI_FLAG_KAMIKAZE              (AI_FLAG_WILL_SUICIDE | AI_FLAG_RISKY | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)  
#define AI_FLAG_TRICKY                (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_PREDICTION)    
#define AI_FLAG_RIVAL                 (AI_FLAG_LEADER | AI_FLAG_RISKY)         
