...
#define MAX_PER_STAT_EVS 100 //((P_EV_CAP >= GEN_6) ? 252 : 255)
#define MAX_TOTAL_EVS 200
#define EV_ITEM_RAISE_LIMIT 0 // ((I_VITAMIN_EV_CAP >= GEN_8) ? MAX_PER_STAT_EVS : 100)

#define EVS_PER_LEVEL 2
